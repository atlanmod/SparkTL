 ...
 * </p>
 * <ul>
 *   <li>{@link movies.impl.MovieImpl#getPersons <em>Persons</em>}</li>
 *   <li>{@link movies.impl.MovieImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link movies.impl.MovieImpl#getRating <em>Rating</em>}</li>
 *   <li>{@link movies.impl.MovieImpl#getYear <em>Year</em>}</li>
 *   <li>{@link movies.impl.MovieImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MovieImpl extends ContainedElementImpl implements Movie {
	/**
	...
	public void setYear(int newYear) {
		...
		year = newYear;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MoviesPackage.MOVIE__YEAR, oldYear, year));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MoviesPackage.MOVIE__TYPE, oldType, type));
	}
