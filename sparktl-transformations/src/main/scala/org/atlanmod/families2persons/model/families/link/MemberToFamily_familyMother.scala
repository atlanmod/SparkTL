...
class MemberToFamily_familyMother (source: FamiliesMember, target: FamiliesFamily)
  extends FamiliesLink( FamiliesMetamodelNaive.MOTHER_TO_FAMILY, source, List(target)){
