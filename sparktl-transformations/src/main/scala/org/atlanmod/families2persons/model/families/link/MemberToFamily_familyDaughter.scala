...
class MemberToFamily_familyDaughter (source: FamiliesMember, target: FamiliesFamily)
  extends FamiliesLink( FamiliesMetamodelNaive.DAUGHTER_TO_FAMILY, source, List(target)){
