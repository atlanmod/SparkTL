...
class MemberToFamily_familySon (source: FamiliesMember, target: FamiliesFamily)
  extends FamiliesLink( FamiliesMetamodelNaive.SON_TO_FAMILY, source, List(target)){
