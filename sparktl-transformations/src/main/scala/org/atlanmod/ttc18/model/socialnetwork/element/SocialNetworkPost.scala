...
class SocialNetworkPost extends SocialNetworkSubmission(SocialNetworkMetamodelNaive.POST){
    ...
    override def equals(o: Any): Boolean = {
        o match {
            case obj: SocialNetworkPost => this.getId.equals(obj.getId) & this.getContent.equals(obj.getContent) &
    ...
    override def weak_equals(o: Any): Boolean = {
        o match {
            case obj: SocialNetworkPost  => this.getContent.equals(obj.getContent) &
