...
import org.atlanmod.dblpinfo.tranformation.DblpHelpers.{helper_active_ICMT, helper_hasPapersICMT}
        ...
        new TransformationImpl[DynamicElement, DynamicLink, String, DynamicElement, DynamicLink](List(
            new RuleImpl(
                ...
                from = (model, pattern) => {
                    ...
                    Some(helper_hasPapersICMT(m, author, meta) && helper_active_ICMT(m, author, meta))
                },
                to = List(
