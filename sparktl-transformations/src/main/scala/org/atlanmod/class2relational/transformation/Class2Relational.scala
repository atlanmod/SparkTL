...
import org.atlanmod.class2relational.model.classmodel.{ClassAttribute, ClassClass, ClassDatatype, ClassMetamodel, ClassModel}
import org.atlanmod.class2relational.model.relationalmodel.{ColumnToTable, ColumnToType, RelationalColumn, RelationalMetamodel, RelationalTable, RelationalType, TableToColumns, TableToKeys}
