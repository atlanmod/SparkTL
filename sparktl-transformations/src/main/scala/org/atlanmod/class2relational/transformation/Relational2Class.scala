...
import org.atlanmod.class2relational.model.classmodel.{AttributeToClass, AttributeToType, ClassAttribute, ClassClass, ClassDatatype, ClassMetamodel, ClassToAttributes}
import org.atlanmod.class2relational.model.relationalmodel.{RelationalColumn, RelationalMetamodel, RelationalModel, RelationalTable, RelationalTypable, RelationalType}
...
object Relational2Class {
    ...
    val mm: DynamicMetamodel[DynamicElement, DynamicLink] = RelationalMetamodel.metamodel
