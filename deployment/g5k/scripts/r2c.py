...
conf = (
    ...
    G5kConf.from_settings(job_type="allow_classic_ssh", job_name=my_job, walltime="02:00:00")
        ...
        try:
            p.shell(
                "/home/"+username+"/Software/spark-3.1.1-bin-hadoop2.7/bin/spark-submit \
                    ...
                    --class org.atlanmod.Main_Relational2Class_ByRule \
                    /home/jphilippe/jars/SparkTE-1.0-SNAPSHOT.jar -core "+str(nb_core)+" -executor "+str(nb_worker)+" -size " + str(size) + " -mode sleeping -sleep " +str(sleep)+" \
                    >> " + path_log + " 2>> " + path_err
            )
