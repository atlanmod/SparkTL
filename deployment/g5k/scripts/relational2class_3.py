...
conf = (
    G5kConf.from_settings(job_type="allow_classic_ssh", job_name="SPARK_relational2class_3", reservation="2021-03-30 19:00:00", walltime="13:00:00")
...
def bench(parameter, master, roles, username, ntest):
    ...
    path_log = "/tmp/sparkte_r2c_3.log"
    path_err = "/tmp/sparkte_r2c_3.err"
...
# Run the job
    ...
    for test in range(10):
        ...
        sweeper = ParamSweeper(
            persistence_dir=str(Path("sweeps_3_"+str(test))), sweeps=sweeps, save_sweeps=True
        )
