...
conf = (
    G5kConf.from_settings(job_type="allow_classic_ssh", job_name="SPARK_relational2class_1", reservation="2021-03-30 19:00:00", walltime="3:00:00")
...
# Run the job
    ...
    for test in range(10):
        ...
        sweeper = ParamSweeper(
            persistence_dir=str(Path("sweeps_1_"+str(test))), sweeps=sweeps, save_sweeps=True
        )
