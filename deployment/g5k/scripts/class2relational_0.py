...
conf = (
    G5kConf.from_settings(job_type="allow_classic_ssh", job_name="SPARK_class2relational_dumb_0", reservation="2021-04-20 19:00:00", walltime="4:00:00")
...
def bench(parameter, master, roles, username, ntest):
    ...
    path = "/home/jphilippe/c2r_results_0_"+str(ntest)
    path_log = "/tmp/sparkte_c2r_0.log"
    path_err = "/tmp/sparkte_c2r_0.err"
