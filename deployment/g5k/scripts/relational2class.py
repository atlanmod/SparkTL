...
conf = (
    G5kConf.from_settings(job_type="allow_classic_ssh", job_name="SPARK_relational2class_full", reservation="2021-05-12 20:00:00", walltime="12:00:00")
    # G5kConf.from_settings(job_type="allow_classic_ssh", job_name="SPARK_relational2class", walltime="2:00:00")
