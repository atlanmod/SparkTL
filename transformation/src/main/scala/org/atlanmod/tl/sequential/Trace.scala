...
import org.atlanmod.tl.sequential.impl.TraceLinkImpl
import org.atlanmod.tl.sequential.spec.{Metamodel, Model, OutputPatternElement, Rule, TraceLink, Transformation}
...
object Trace {
    ...
    private def traceIterationOnPattern[SME, SML, SMC, TME, TML](r:Rule[SME, SML, SMC, TME, TML], sm: Model[SME, SML],
                                                                 sp: List[SME], iter: Int) : List[TraceLink[SME, TME]] = {
    ...
    private def traceRuleOnPattern[SME, SML, SMC, TME, TML](r:Rule[SME, SML, SMC, TME, TML], sm: Model[SME, SML],
                                                            sp: List[SME]) : List[TraceLink[SME, TME]] = {
