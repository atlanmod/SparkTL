...
data <- read.csv(file="150_220_4partitions_Jul_1.csv", colClasses=colTypes, comment.char = "#")
```
...
for(i in sleeping_times){
  ...
  df.toprint = subset(df.sleeping, select = c(sleeping_time,element,link,executor,core,partition,count,total_time.speedup,time_instantiate.speedup,time_apply.speedup))
  print(df.toprint)
}
```
