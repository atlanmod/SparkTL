...
object Main_Relational2Class_Step1_local {
    ...
    def main(args: Array[String]): Unit = {
        ...
        var transformation = org.atlanmod.class2relational.transformation.dynamic.Relational2Class.relational2class(sleeping_guard, sleeping_instantiate, sleeping_apply)
