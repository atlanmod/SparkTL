...
object TransformationEngineTwoPhaseMorePara1 extends ExperimentalTransformationEngine  {
        /*
         ...
         */
        private def instantiateTraces[SME, SML, SMC, SMR, TME: ClassTag, TML: ClassTag]
