...
object HM_paralleltrace_paralleltuples extends ExperimentalTransformationEngine {
    ...
    : (List[TME], TraceLinks[SME, TME]) = {
        val tls : TraceLinks[SME, TME] = Trace.trace_paralleltuples_parallelHM(tr, sm, mm, sc)
