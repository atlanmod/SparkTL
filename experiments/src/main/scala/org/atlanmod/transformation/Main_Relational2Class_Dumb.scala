...
object Main_Relational2Class_Dumb {
...
//        header :: lines
    ...
    def run_experiment_sizes_csv_files(sizes: List[Int], times: Int, ncore: Int): List[String] = {
        ...
        val transformation = org.atlanmod.transformation.dynamic.Relational2Class.relational2class_sleeping_instantiate_and_apply()
