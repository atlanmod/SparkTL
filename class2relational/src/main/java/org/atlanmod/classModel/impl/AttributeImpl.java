...
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute {
	 ...
	 */
	@Override
	public org.atlanmod.classModel.Class getType() {
		if (eContainerFeatureID() != ClassPackage.ATTRIBUTE__TYPE)
			return null;
		return (org.atlanmod.classModel.Class) eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetType(org.atlanmod.classModel.Class newType, NotificationChain msgs) {
	 ...
	 */
	@Override
	public void setType(org.atlanmod.classModel.Class newType) {
		if (newType != eInternalContainer()
			...
			if (newType != null)
				msgs = ((InternalEObject) newType).eInverseAdd(this, ClassPackage.CLASS__ATTRIBUTES,
						org.atlanmod.classModel.Class.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ClassPackage.ATTRIBUTE__TYPE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetType((org.atlanmod.classModel.Class) otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ClassPackage.ATTRIBUTE__NAME:
			...
			return;
		case ClassPackage.ATTRIBUTE__TYPE:
			setType((org.atlanmod.classModel.Class) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case ClassPackage.ATTRIBUTE__NAME:
			...
			return;
		case ClassPackage.ATTRIBUTE__TYPE:
			setType((org.atlanmod.classModel.Class) null);
			return;
		}
