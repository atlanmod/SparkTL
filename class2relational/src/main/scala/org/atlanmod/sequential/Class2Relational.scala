                    ...
                    to =
                      List(
                          new OutputPatternElementImpl(
                              name = "tab",
                              elementExpr = (_, _, l) => {
                                  val _class = l.head.asInstanceOf[org.atlanmod.generated.classModel.Class]
                              ...
                              outputElemRefs = List(
                                  new OutputPatternElementReferenceImpl(
                                      (tls, i, m, c, t) => {
                                          val attrs = c.head.asInstanceOf[org.atlanmod.generated.classModel.Class].getAttributes
                    ...
                    to =
                      List(
                          new OutputPatternElementImpl(
                              name = "col",
                              elementExpr = (_, _, l) => {
                                  val attribute = l.head.asInstanceOf[org.atlanmod.generated.classModel.Attribute]
