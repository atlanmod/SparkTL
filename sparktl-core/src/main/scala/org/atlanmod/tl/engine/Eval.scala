...
object Eval {
    ...
    def evalOutputPatternElementExpr[SME, SML, SMC, TME, TML](sm: Model[SME, SML], sp: List[SME], iter: Int,
                                                              o: OutputPatternElement[SME, SML, TME, TML])
    : Option[TME] =
        o.getElementExpr(iter, sm, sp)

    def evalOutputPatternLinkExpr[SME, SML, SMC, TME, TML](sm: Model[SME, SML], sp: List[SME], oe: TME, iter: Int,
