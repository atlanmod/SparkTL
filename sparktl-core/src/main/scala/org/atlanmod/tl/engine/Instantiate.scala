...
object Instantiate {
    ...
    @tailrec
    def checkTypes[ID, SME, SML, SMC, SMR](ses: List[SME], scs: List[SMC], mm: Metamodel[ID, SME, SML, SMC, SMR])
    : Boolean =
        (ses, scs) match {
    ...
    def matchRuleOnPattern[ID, SME, SML, SMC, SMR, TME, TML, STL, TTL](r: Rule[SME, SML, SMC, TME, TML, STL, TTL],
    ...
    def matchPattern[ID, SME, SML, SMC, SMR, TME, TML,  STL, TTL](tr: Transformation[SME, SML, SMC, TME, TML, STL, TTL],
                                                   sm: Model[SME, SML],  mm: Metamodel[ID, SME, SML, SMC, SMR],
                                                   sp: List[SME])
    : List[Rule[SME, SML, SMC, TME, TML, STL, TTL]] =
        tr.getRules.filter(r => matchRuleOnPattern(r, sm, mm, sp))


    def instantiateElementOnPattern[SME, SML, SMC, TME, TML, STL, TTL](o: OutputPatternElement[SME, SML, TME, TML, STL, TTL],
                                                             sm: Model[SME, SML], sp: List[SME], iter: Int)
    : Option[TME] =
        evalOutputPatternElementExpr(sm, sp, iter, o)


    private def instantiateIterationOnPattern[SME, SML, SMC, TME, TML, STL, TTL](r: Rule[SME, SML, SMC, TME, TML, STL, TTL],
                                                                       sm: Model[SME, SML], sp: List[SME], iter: Int)
    : List[TME] =
        r.getOutputPatternElements.flatMap(o => ListUtils.optionToList(instantiateElementOnPattern(o, sm, sp, iter)))


    private def instantiateRuleOnPattern[SME, SML, SMC, TME, TML, STL, TTL](r: Rule[SME, SML, SMC, TME, TML, STL, TTL], sm: Model[SME, SML],
                                                                  sp: List[SME])
    : List[TME] =
        indexes(evalIteratorExpr(r, sm, sp)).flatMap(index => instantiateIterationOnPattern(r, sm, sp, index))


    def instantiatePattern[ID, SME, SML, SMC, SMR, TME, TML, STL, TTL](tr: Transformation[SME, SML, SMC, TME, TML, STL, TTL],
                                                         sm: Model[SME, SML],  mm: Metamodel[ID, SME, SML, SMC, SMR],
                                                         sp: List[SME])
    : List[TME]={
