...
object Trace {
    ...
    private def traceElementOnPattern[SME, SML, SMC, TME, TML](o: OutputPatternElement[SME, SML, SMC, TME, TML],
    ...
    private def traceIterationOnPattern[SME, SML, SMC, TME, TML](r:Rule[SME, SML, SMC, TME, TML], sm: Model[SME, SML, SMC],
    ...
    private def traceRuleOnPattern[SME, SML, SMC, TME, TML](r:Rule[SME, SML, SMC, TME, TML], sm: Model[SME, SML, SMC],
                                                            sp: List[SME])
    : List[TraceLink[SME, TME]] =
